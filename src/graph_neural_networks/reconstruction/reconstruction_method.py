...
class ReconstructionMethod():
    ...
    def get_reconstruction_mask(self,
                            mask: torch.Tensor,
                            paths: list[np.array],
    ...
    def draw_reconstruction(self,
        ...
        reconstruction_mask = self.get_reconstruction_mask(mask, paths, radius_paths)
    ...
    def reconstruct(self, 
        ...
        radius_paths = self.radius_reconstruction.reconstruct(map, graph, new_edges, paths)
