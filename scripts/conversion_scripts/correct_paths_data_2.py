...
def cut_mask_from_negative_edges_for_all(centerlines, mask, classes=None, return_old_centerlines=False):
    new_centerlines = []
    new_classes = []
    old_centerlines = []
    ...
    if return_old_centerlines:
        return new_centerlines, old_centerlines
    else:
...
def process_case(i):
    ...
    true_path_reconstructed_centerlines, true_path_reconstruced_classes = cut_mask_from_negative_edges_for_all(true_path_reconstructed_centerlines, segmentation_mask_np, classes=true_path_reconstruced_classes)
    ...
    train_negative_centerlines = cut_mask_from_negative_edges_for_all(train_negative_centerlines, segmentation_mask_np)
    ...
    eval_path_centerlines_cut, eval_path_centerlines = cut_mask_from_negative_edges_for_all(eval_path_centerlines, segmentation_mask_np, return_old_centerlines=True)
